...
static const _Uhuy_type_support_symbol_names_t _Uhuy_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, example_infs, msg, Uhuy)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, example_infs, msg, Uhuy)),
  }
};
...
{
  return &::example_infs::msg::rosidl_typesupport_cpp::Uhuy_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, example_infs, msg, Uhuy)() {
  return get_message_type_support_handle<example_infs::msg::Uhuy>();
}
