...
#ifndef EXAMPLE_INFS__SRV__DETAIL__PRINT__FUNCTIONS_H_
#define EXAMPLE_INFS__SRV__DETAIL__PRINT__FUNCTIONS_H_
...
/// Create srv/Print message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * example_infs__srv__Print_Request__init().
...
/// Destroy srv/Print message.
/**
 * It calls
 * example_infs__srv__Print_Request__fini()
...
/// Check for srv/Print message equality.
/**
...
/// Initialize array of srv/Print messages.
/**
...
/// Finalize array of srv/Print messages.
/**
 * It calls
 * example_infs__srv__Print_Request__fini()
...
/// Create array of srv/Print messages.
/**
 * It allocates the memory for the array and calls
 * example_infs__srv__Print_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Print messages.
/**
 * It calls
 * example_infs__srv__Print_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Print message array equality.
/**
...
/// Copy an array of srv/Print messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * example_infs__srv__Print_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_example_infs
...
/**
 * It calls
 * example_infs__srv__Print_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_example_infs
...
/**
 * It allocates the memory for the array and calls
 * example_infs__srv__Print_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_example_infs
...
/**
 * It calls
 * example_infs__srv__Print_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // EXAMPLE_INFS__SRV__DETAIL__PRINT__FUNCTIONS_H_
